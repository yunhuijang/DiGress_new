...
from datasets.spectre_dataset import SBMDataModule, Comm20DataModule, PlanarDataModule, SpectreDatasetInfos, EgoDataModule, LobsterDataModule, ProteinDataModule, PointDataModule, EgoLargeDataModule
...
def main(cfg: DictConfig):
    ...
    if dataset_config["name"] in ['sbm', 'comm-20', 'planar', 'ego_small', 'lobster', 'ego', 'proteins', 'point']:
        if dataset_config['name'] == 'sbm':
            ...
            if name == 'comm-20':
                ...
                datamodule = LobsterDataModule(cfg)
            elif name == 'ego':
                datamodule = EgoLargeDataModule(cfg)
            elif name == 'proteins':
                datamodule = ProteinDataModule(cfg)
            elif name == 'point':
                datamodule = PointDataModule(cfg)
            else:
                assert False, "No data name"
            # assert False, datamodule.dataloaders
